				...
				<div class="row">
					...
					<div id="main" class="col-md-9">
                        ...
                        <h2>Job Description</h2>
                            ...
                            <!-- row -->
                            <div class="row">
							<h2>Companies Offering Software Tester Jobs</h2>
    
							<ol style="font-size:16px;">
                                <li><b>1.</b> LTI - Larsen & Toubro Infotech</li>
                                <li><b>2.</b> Wipro</li>
                                <li><b>3.</b> Spiceworks</li>
                                <li><b>4.</b> Tata Consultancy Services</li>
                                <li><b>5.</b> Intel Technology India Pvt Ltd</li>
                                <li><b>6.</b> AT & T communications Services India</li>
                            </ol>
                            </div>
                            <!-- /row -->
