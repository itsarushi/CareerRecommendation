					...
					<div id="main" class="col-md-9">
                        ...
                        <h2>Job Description</h2>
							...
							<ol style="font-size:16px;">
                                ...
                                <li><b>4. Analytical thinking - </b>logically examining the steps taken and the outcome helps hardware engineers make corrections and produce better results</li>
                            ...
                            <!-- row -->
                            <div class="row">
							<h2>Companies Offering Hardware Engineer Jobs</h2>
