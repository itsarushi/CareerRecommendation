				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1 text-center">
						<ul class="hero-area-tree">
							...
							<li><a href="blog.php">JOB PROFILES</a></li>
				...
				<div class="row">
					...
					<div id="main" class="col-md-9">
                        ...
                        <h2>Job Description</h2>
                            ...
                            <div class="row">
							<h2>Salary</h2>
							<p style="font-size:16px;">The average salary for an API Integration Specialist is Rs. 7,31,000 per annum.</p>
                            </div>
                            <!-- /row -->

                            <!-- row -->
                            <div class="row">
							<h2>Companies Offering API Integration Specialist Jobs</h2>
    
							<ol style="font-size:16px;">
                                <li><b>1.</b> Uber</li>
                                <li><b>2.</b> Barclays</li>
                                <li><b>3.</b> IBM</li>
                                <li><b>4.</b> Philips</li>
                                <li><b>5.</b> Larsenn and Tourbo Infotech Limited</li>
                                <li><b>6.</b> Oracle</li>
                                <li><b>7.</b> Bank of America</li>
                            </ol>
                            </div>
                            <!-- /row -->
