				...
				<div class="row">
					...
					<div id="main" class="col-md-9">
                        ...
                        <h2>Job Description</h2>
                            ...
                            <!-- row -->
                            <div class="row">
							<h2>Companies Offering Graphic Designer Jobs</h2>
    
							<ol style="font-size:16px;">
                                <li><b>1.</b> Buttercup advertising studio</li>
                                <li><b>2.</b> Sigzen Technologies</li>
                                <li><b>3.</b> Mind digital</li>
                                <li><b>4.</b> Webisdom</li>
                                <li><b>5.</b> Zero designs</li>
                                <li><b>6.</b> Netgains</li>
                                <li><b>7.</b> Detecvision</li>
                                <li><b>8.</b> WiseLife</li>
                            </ol>
                            </div>
                            <!-- /row -->
